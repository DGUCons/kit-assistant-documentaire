...
Claude Code est l'application qui permet à l'assistant de travailler sur vos fichiers, chez vous.
...
1. Même page officielle : [claude.com/claude-code](https://claude.com/claude-code)
2. Téléchargez la version macOS, glissez l'application dans le dossier Applications.
3. Ouvrez-la et connectez-vous avec votre compte Claude.
