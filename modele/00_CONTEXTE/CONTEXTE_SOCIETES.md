# Contexte : vos structures

> Rempli avec l'assistant lors de l'installation guidée (START.md, phases P1 et P2), complété en phase P4. Relu en début de chaque session : c'est la fiche d'identité documentaire de votre activité. Tenez-le à jour quand quelque chose change (banque, cabinet, nouvelle structure) : dites-le simplement à l'assistant.

## Structure 1

- Nom : [NOM]
- Type : [société / SCI / entreprise individuelle / association / autre]
- Forme juridique : [SASU / EURL / SCI / EI / autre, ou « à vérifier »]
- SIREN : [9 chiffres, ou « à vérifier »] ; source : [annuaire public / fourni par l'utilisateur]
